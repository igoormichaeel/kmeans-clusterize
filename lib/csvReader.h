...
/*
 * This function checks if the column that we are parsing from csv is required
 * column or not. If the column is valid we would use it for the clustering if
 * not we would discard it.
 */
